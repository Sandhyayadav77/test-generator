...
//                     if (chapterData) {
//                         const filtered = chapterData.categories.reduce(
//                             (allQuestions, category) => allQuestions.concat(category.questions),
//                             []
//                         );
//                         setFilteredQuestions(filtered);
//                     } else {
//                         setFilteredQuestions([]); // Set to an empty array if the chapter has no questions
//                     }
//                 } else {
//                     setFilteredQuestions([]); // Set to an empty array if the class has no questions
//                 }
//             } else {
//                 setFilteredQuestions([]); // Set to an empty array if the subject has no questions
//             }
//         } catch (error) {
//             console.error('An error occurred while filtering questions:', error);
//             setFilteredQuestions([]); // Set to an empty array if an error occurs
//         }
